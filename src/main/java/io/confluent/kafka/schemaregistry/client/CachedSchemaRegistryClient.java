...
public class CachedSchemaRegistryClient implements SchemaRegistryClient {
    ...
    public void putVersion(String subject, Schema schema, int version) {
        ...
        if (((Map)schemaVersionMap).containsKey(schema) && (int)((Map)schemaVersionMap).get(schema) == version) {
    ...
    public void putId(String subject, Schema schema, int id) throws IOException, RestClientException {
        Object idSchemaMap;
        if (this.idCache.containsKey(subject)) {
